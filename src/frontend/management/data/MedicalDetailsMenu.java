...
public class MedicalDetailsMenu extends JPanel {
	...
	public MedicalDetailsMenu(Patient patient) {
		 ...
		 */
		cDetails.gridy = 2;
		JButton previousBtn = new JButton(new ImageIcon(getClass().getResource("src/frontend/management/res/previous.gif")));
		...
		JButton nextBtn = new JButton(new ImageIcon(getClass().getResource("src/frontend/management/res/next.gif")));

...
public class ManagementMenu extends JPanel {
	...
	public ManagementMenu() {
		...
		JButton openBtn = new JButton(new ImageIcon(getClass().getResource("/frontend/management/res/open.gif")));
		...
		JButton saveBtn = new JButton(new ImageIcon(getClass().getResource("/frontend/management/res/save.gif")));
		...
		JButton addBtn = new JButton(new ImageIcon(getClass().getResource("/frontend/management/res/add.gif")));
		...
		JButton deleteBtn = new JButton(new ImageIcon(getClass().getResource("/frontend/management/res/delete.gif")));
		...
		JButton editBtn = new JButton(new ImageIcon(getClass().getResource("/frontend/management/res/edit.gif")));
		...
		JButton searchBtn = new JButton(new ImageIcon(getClass().getResource("/frontend/management/res/search.gif")));
